...
def se_resnet50(num_classes, kaiminginit):
    model = ResNet(SEBottleneck, [3, 4, 6, 3], num_classes, kaiminginit)
    return model
    
# resnet 34 related models:
...
def se_resnet34(num_classes, kaiminginit):
    model = ResNet(SEBasicBlock, [3, 4, 6, 3], num_classes, kaiminginit)
    return model